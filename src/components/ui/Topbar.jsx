...
export default function Topbar({ 
  ...
  subtitle, 
  actions,
  sidebarWidth = 260  // ← Tambah props ini
}) {
  ...
  return (
    <header 
      className="fixed top-0 right-0 h-16 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 flex items-center px-6 gap-4 z-40 transition-colors duration-300"
      style={{ left: sidebarWidth }}  {/* ← Ganti hardcoded left */}
    >
